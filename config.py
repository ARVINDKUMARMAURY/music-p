...
class Config:
    def __init__(self):
        ...
        # Database
        self.MONGO_URL: str = getenv("MONGO_DB_URI", "mongodb+srv://yb131567_db_user:R8zxuvc9Qn999Arg@cluster0.drjaxl8.mongodb.net/telegram_bot_2?retryWrites=true&w=majority")
        ...
        # Support Links
        self.SUPPORT_CHANNEL: str = getenv("SUPPORT_CHANNEL", "https://t.me/Elevenschats")
        self.SUPPORT_CHAT: str = getenv("SUPPORT_CHAT", "https://t.me/Artisots")
        ...
        # Images
        self.DEFAULT_THUMB: str = getenv("DEFAULT_THUMB", "https://i.ibb.co/MkS4qhSh/anime.jpg")
        self.PING_IMG: str = getenv("PING_IMG", "https://i.ibb.co/MkS4qhSh/anime.jpg")
        self.START_IMG: str = getenv("START_IMG", "https://i.ibb.co/MkS4qhSh/anime.jpg")
        self.RADIO_IMG: str = getenv("RADIO_IMG", "https://i.ibb.co/MkS4qhSh/anime.jpg")
